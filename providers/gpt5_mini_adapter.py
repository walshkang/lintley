...
class GPT5MiniAdapter:
    ...
    def __init__(self, use_mock: Optional[bool] = None, actor_patch: Optional[str] = None) -> None:
    ...
    async def stream(self, system_prompt: str, user_message: str, max_tokens: int = 1000):
